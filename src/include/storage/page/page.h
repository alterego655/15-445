...
class Page {
 ...
 public:
  ...
  /** set pin count of this page */
  inline void SetPinCount(int pin_num) { pin_count_ = pin_num; }

  /** add pin count of this page */
  inline void IncrePinCount() { pin_count_++; }

  /** decrease pin count of this page */
  inline void DecrePinCount() { pin_count_--; }
